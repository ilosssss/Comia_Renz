...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        body{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:2rem;background:linear-gradient(135deg,#6366f1 0%,#4338ca 100%);font-family:Segoe UI,Arial,sans-serif}
        .card{width:100%;max-width:420px;background:#fff;border-radius:16px;box-shadow:0 25px 60px rgba(0,0,0,.25);overflow:hidden}
        ...
        input{width:100%;padding:.85rem 1rem;border:2px solid #e5e7eb;border-radius:10px;background:#fff}
        ...
        <div class="content">
            <form action="<?= site_url('auth/login'); ?>" method="post">
                ...
                <div class="actions">
                    ...
                    <a class="btn btn-secondary" href="<?= site_url('auth/register'); ?>">Sign up</a>
                </div>
                <div class="muted">Don’t have an account yet? Click Sign up.</div>
            </form>
        </div>
    </div>
</body>
